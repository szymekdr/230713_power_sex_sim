...
```{r}
#| fig-cap: Sample size vs. effect strength using GLS; no interaction present.
#| label: fig-gls1
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength using GLS; interaction with more variable sex with stronger effect.
#| label: fig-gls2
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength using GLS; less variable sex with stronger effect.
#| label: fig-gls3
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength using sandwich estimator; no interaction.
#| label: fig-sand1
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength using sandwich estimator; interaction in the direction of heteroscedasticity.
#| label: fig-sand2
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength using sandwich estimator; interaction opposite to the direction of heteroscedasticity.
#| label: fig-sand3
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength with symmetrical heteroscedasticity; no interaction.
#| label: fig-sym1
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength with symmetrical heteroscedasticity; interaction in the direction of heteroscedasticity.
#| label: fig-sym2
#| code-fold: true
...
```{r}
#| fig-cap: Sample size vs. effect strength with symmetrical heteroscedasticity; interaction opposite to the direction of heteroscedasticity.
#| label: fig-sym3
#| code-fold: true
